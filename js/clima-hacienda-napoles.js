...
const latitude = '5.901260'; // Reemplaza con la latitud de Santa Fé, Antioquia - Colombia
const longitude = '-74.724051'; // Reemplaza con la longitud de Santa Fé, Antioquia - Colombia
  ...
  fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=${apiKey}&units=metric`)
    ...
    .then(data => {
      ...
      weatherDiv.innerHTML = `
        <h2>El clima en Puerto Triunfo, Antioquia - Colombia</h2>
