...
const latitude = '6.559684'; // Reemplaza con la latitud de Santa Fé, Antioquia - Colombia
const longitude = '-75.827712'; // Reemplaza con la longitud de Santa Fé, Antioquia - Colombia
  ...
  fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=${apiKey}&units=metric`)
    ...
    .then(data => {
      ...
      weatherDiv.innerHTML = `
        <h2>El clima en Santa Fe, Antioquia - Colombia</h2>
