...
const latitude = '5.589906'; // Reemplaza con la latitud de Santa Fé, Antioquia - Colombia
const longitude = '-75.867232'; // Reemplaza con la longitud de Santa Fé, Antioquia - Colombia
  ...
  fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=${apiKey}&units=metric`)
    ...
    .then(data => {
      ...
      weatherDiv.innerHTML = `
        <h2>El clima en Río Claro, Jardín, Antioquia - Colombia</h2>
